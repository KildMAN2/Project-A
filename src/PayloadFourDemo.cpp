...
int main(int argc, char** argv)
{
    ...
    // Set bounds before any mesh or state setup
    sys.setDefaultBounds();
    ...
    // Define start & goal states BEFORE calling setup
    ...
    // Save solution path if not using custom state logging
