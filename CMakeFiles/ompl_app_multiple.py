...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def openEnvironment(self):
        ...
        fname = os.path.join(os.path.dirname(__file__), '../meshes/Apartment_env.dae')
    ...
    def openRobot(self):
        ...
        fname_box = os.path.join(os.path.dirname(__file__), '../meshes/box.dae')
        fname_drone = os.path.join(os.path.dirname(__file__), '../meshes/drone.dae')
